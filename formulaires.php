		...
		<div class="modal-content">
			...
			<form class="form-signin" role="form" method="post" action="?&action=connection">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-parabellumW">Connexion</button>
				</div>
				</form>
		</div>
	</div>
...
<div class="modal fade" id="passRecover" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel"><b>Mot de passe oublié ?</b></h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</button>
			</div>
			<form class="-signin" role="form" method="post" action="?&action=passRecover">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
					<button type="submit" class="btn btn-parabellumW">Envoyer</button>
				</div>
			</form>
		</div>
	</div>
...
<div class="modal fade" id="InscriptionSlide" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel"><b>Inscription</b></h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<form role="form" method="post" action="?&action=inscription">
				<div class="modal-body">
					<div class="alert alert-info text-center" style="text-align: center;">Veuillez mettre une adresse email correcte !</div>
					<div class="form-group row">
						<label for="PseudoInscriptionForm" class="col-md-2 col-form-label"><span class="requiredField">*</span> Pseudo</label>
						<div class="col-md-8">
							<input type="text" name="pseudo" class="form-control" id="PseudoInscriptionForm" placeholder="Votre pseudo exact In-Game">
						</div>
					</div>
					<div class="form-group row">
						<label for="EmailInscriptionForm" class="col-md-2 col-form-label"><span class="requiredField">*</span> Email</label>
						<div class="col-md-8">
					...
					<div class="form-group row">
						<label for="MdpInscriptionForm" class="col-md-2 col-form-label"><span class="requiredField">*</span> Mot de passe</label>
						<div class="col-md-8">
							<input type="password" name="mdp" class="form-control" onKeyUp="securPass();" id="MdpInscriptionForm" placeholder="Votre mot de passe">
						</div>
					</div>
					<div class="form-group row">
						<label for="MdpConfirmInscriptionForm" class="col-md-2 col-form-label"><span class="requiredField">*</span> Mot de passe</label>
						<div class="col-md-8">
					...
					<div class="form-group row">
						<div class="col-md-12 mr-3">
							Les champs obligatoires sont précédés par une étoile <b>( <span class="requiredField">*</span> )</b>
						</div>
					</div>
				</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
					<button type="submit" class="btn btn-parabellumW" id="InscriptionBtn">S'inscrire</button>
				</div>
			</form>
		</div>
	</div>
