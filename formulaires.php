...
<div class="modal fade" id="InscriptionSlide" tabindex="-1" role="dialog" aria-labelledby="InscriptionSlide" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form role="form" method="post" action="?&action=inscription" class="bg-parabellum">
                ...
                <div class="modal-body pt-3">
                        ...
                        <div class="col-md-12 py-2">
                            ...
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    <div class="input-group-text bg-parabellum border-0">
                    ...
                    <div class="form-row py-1">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input style="color: black;" type="password" name="mdp" class="form-control custom-text-input" id="MdpInscriptionForm" placeholder="Entrez votre mot de passe" onKeyUp="securPass();" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group" >
                                ...
                                <input style="color: black;" type="password" name="mdpConfirm" class="form-control custom-text-input" id="MdpConfirmInscriptionForm" placeholder="Entrez votre mot de passe" onKeyUp="securPass();" required>
                            </div>
                        </div>

                        <div class="col-md-12 mt-3">
                            <div class="col-md-12 d-none" id="progress">
                                <span style="background-color: whitesmoke" id="correspondance"></span>
                                <div class="progress">
                    ...
                    <div class="form-row py-2">
                        ...
                        <div class="col-md-6">
                            <button type="button" onclick='var t=document.getElementById("captcha"); t.src=t.src+"&amp;"+Math.random();' class="btn btn-reverse" style="margin-top:35px; color: black">
...
<div class="modal fade" id="ConnectionSlide" tabindex="-1" role="dialog" aria-labelledby="ConnectionSlide" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-signin bg-parabellum" role="form" method="post" action="?&action=connection">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-light w-100" style="color: black;">Se connecter</button>
                </div>
                ...
                <div class="modal fade" id="news<?= $news[$i]['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="news<?= $news[$i]['id']; ?>" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                ...
                                while ($newsComments = $getNewsCommentaires->fetch(PDO::FETCH_ASSOC)) :
                                    ...
                                    <div class="media m-2 pb-4">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span style="color: black"><?php echo $newsComments['commentaire'];?></span>
                            ...
                            <?php if (Permission::getInstance()->verifPerm("connect")) : ?>
                                <div class="modal-footer w-100 bg-parabellum">
                                    <form action="?&action=post_news_commentaire&id_news=<?php echo $news[$i]['id']; ?>" method="post" class="w-100">
                                        <h5>
                                            Commenter !
                                        </h5>
                                        <textarea name="commentaire" class="form-control w-100 mb-3" style="color: black;" required></textarea>
                                        <small>
                                            <span class="float-left"><b>Min : </b> 6 charactères. </span>
                                            <span class="float-right"><b>Max : </b> 255 charactères.</span>
                                        </small>
                                        <button type="submit" class="btn btn-light w-100 mt-3" style="color: black;">Commenter</button>
                                    </form>
                                </div>
                            <?php else : ?>
                                <div class="modal-footer text-center bg-parabellum">
                    ...
                    while ($newsComments = $getNewsCommentaires->fetch(PDO::FETCH_ASSOC)) :
                        ...
                        if ($newsComments['pseudo'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm("createur")) :  ?>
                            <div class="modal fade" id="news<?= $news[$i]['id'] . '-' . $newsComments['id'] . '-edit'; ?>" tabindex="-1" role="dialog" aria-labelledby="news<?= $news[$i]['id'] . '-' . $newsComments['id'] . '-edit'; ?>" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content bg-parabellum">
                                        <div class="modal-header bg-parabellum">
                                        ...
                                        <form action="?&action=edit_news_commentaire&id_news=<?= $news[$i]['id'] . '&auteur=' . $newsComments['pseudo'] . '&id_comm=' . $newsComments['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <textarea  name="old_commentaire" id="old_commentaire" rows="3" style="resize: none; color: black" class="form-control disabled mb-5" disabled><?= $editCommentaire; ?></textarea>
                                            ...
                                            <div class="modal-footer text-center bg-parabellum">
                                                <small class="w-100">
                                                    <span class="float-left" style="color: black"><b>Min : </b> 6 charactères. </span>
                                                    <span class="float-right"style="color: black"><b>Max : </b> 255 caractères.</span>
                                                </small>
