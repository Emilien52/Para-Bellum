...
<section class="layout" id="white">
		<div class="container">
			<h1 class="titre text-uppercase"><span class="fas fa-angle-double-right"></span> Profil de <?php echo htmlspecialchars($getprofil); ?></h1>
		</div>
</section>
	...
	?>	
			<div class="categories-edit">
						<ul class="nav nav-tabs" id="modifProfil">
							<li class="col-md-4 active" style="text-align: center;"><a href="#infos" data-toggle="tab">Mes infos</a></li>
							<li class="col-md-4" style="text-align: center;"><a href="#autres" data-toggle="tab">Autres</a></li>
							<li class="col-md-4" style="text-align: center;"><a href="#serveur" data-toggle="tab">Donner des jetons</a></li>
						</ul>
					</div>
				<?php 
				...
				<div class="tab-content">
					  ...
					  <div class="form-group">
						<div class="row">
							<div class="col-md-offset-5 col-md-5">
							  <button type="submit" class="btn btn-parabellum validerChange">Valider mes changements</button>
							</div>
						</div>
					  </div>
					</form>				
						...
						<form class="form-horizontal" method="post" action="?&action=changeProfilAutres" role="form">
						  ...
						  <div class="form-group">
						    <div class="col-sm-offset-5 col-sm-5">
						      <button type="submit" class="btn btn-parabellum validerChange">Valider champs facultatifs</button>
						    </div>
						  </div>
						</form>			
					...
					<div class="tab-pane" id="serveur">
						...
						<form class="form-horizontal" method="post" action="?&action=give_jetons" role="form">
						  ...
						  <div class="form-group">
						    <div class="col-sm-offset-5 col-sm-5">
						      <button type="submit" class="btn btn-parabellum validerChange">Envoyer</button>
						    </div>
						  </div>
						</form>	
					</div>
