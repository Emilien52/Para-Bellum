...
<section class="layout" id="white">
	<div class="container">
		<h1 class="titre text-uppercase"><span class="far fa-comments"></span> Forum</h1>
	</div>
</section>
<section class="layout" id="page">
	<div class="container">
		...
		<div class="info-container">
			<h3><strong><span class="fas fa-folder-open"></span> Forum de <?php echo $_Serveur_['General']['name']; ?></strong></h3>
			<p>
				 ...
				 <div class="input-group" >
					<input type="text" id="search-topic" class="form-control" placeholder="Rechercher un topic ou un message" />
						<div class="input-group-append" >
							 <span onclick="searchForum(document.getElementById('search-topic').value, document.getElementById('all-search'), document.getElementById('table-search'),document.getElementById('title-search'))" style="border: none;" class="btn btn-info" style="cursor:pointer;">
    ...
    <div class="container-fluid col-sm-12">
        ...
        <div class="row mt-3">
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'modeJoueur')) : ?>
                <p class="text-center">
                    <a href="?action=mode_joueur" class="btn btn-warning w-100">Passer en mode visuel <?= ($_SESSION['mode']) ? "Administrateur" : "Joueur"; ?></a>
                </p>
            <?php endif; ?>
                            ...
                            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'deleteForum') and !$_SESSION['mode']) : ?>
                                ...
                                <div>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu bg-parabellum" aria-labelledby="dropdownMenuButton">

                                            <form action="?action=modifPermsForum" method="POST">
                                                <input type="hidden" name="id" value="<?= $fofo[$i]['id']; ?>" />
                                                <a class="dropdown-item noHover"><input type="number" name="perms" value="<?= $fofo[$i]['perms']; ?>" class="form-control"></a>
                                                <button type="submit" class="btn btn-block btn-parabellumW text-center">Modifier</button>
                                            </form>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="ordreforum<?= $fofo[$i]['id']; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Modifier l'ordre
                                        </button>

                                        <div class="dropdown-menu bg-parabellum" aria-labelledby="dropdownMenuButton">
                                            <a class="btn btn-block btn-parabellumW" href="?action=ordreForum&ordre=<?= $fofo[$i]['ordre']; ?>&id=<?= $fofo[$i]['id']; ?>&modif=monter">
                                                <i class="fas fa-arrow-up"></i> Monter d'un cran
                                            </a>
                                            <a class="btn btn-block btn-parabellumW" href="?action=ordreForum&ordre=<?= $fofo[$i]['ordre']; ?>&id=<?= $fofo[$i]['id']; ?>&modif=descendre">
                                            ...
                                            <td>
                                                <div class="mx-auto d-flex align-self-center">
                                                    ...
                                                    <div class="dropdown d-inline ml-1">
                                                        ...
                                                        <div class="dropdown-menu bg-parabellum">
                                                            <a class="btn btn-block btn-parabellumW" href="?action=ordreCat&ordre=<?= $categorie[$j]['ordre']; ?>&id=<?= $categorie[$j]['id']; ?>&forum=<?= $categorie[$j]['forum']; ?>&modif=monter">
                                                                <i class="fas fa-arrow-up"></i> Monter d'un cran
                                                            </a>
                                                            <a class="btn btn-block btn-parabellumW" href="?action=ordreCat&ordre=<?= $categorie[$j]['ordre']; ?>&id=<?= $categorie[$j]['id']; ?>&forum=<?= $categorie[$j]['forum']; ?>&modif=descendre">
                                                                <i class="fas fa-arrow-down"></i> Descendre d'un cran
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <button type="button" onclick="openModalEditForum(<?= $categorie[$j]['id']; ?>,'<?= $categorie[$j]['nom']; ?>',<?php echo $fofo[$i]['id']; ?>, <?php if ($categorie[$j]['img'] == NULL) { echo 'null'; }  else { echo "'".$categorie[$j]['img']."'";} ?> );" class="btn btn-warning ml-1" >
		...
		<div class="row">
            ...
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addForum') and !$_SESSION['mode']) : ?>
                ...
                <a class="btn btn-success no-hover col-5 mr-auto" role="button" data-toggle="collapse" href="#add_forum" data-target="#add_forum" aria-expanded="false" aria-controls="add_forum">
            ...
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addCategorie') and !$_SESSION['mode']) : ?>
                ...
                <a class="btn btn-warning no-hover col-5 ml-auto" role="button" data-toggle="collapse" href="#add_categorie" data-target="#add_categorie" aria-exepanded="false" aria-controls="add_categorie">
                    Ajouter un Forum
                </a>

                <div class="collapse col-8 m-3 mx-auto" id="add_categorie" aria-labelledby="add_categorie" data-parent="#collapseContainer">
                        ...
                        <form action="?action=create_cat" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row my-2">
                                    ...
                                    <label for="nomCat" class="color-red">Nom du Forum <span class="star-required"></span></label>
                                ...
                                <div class="form-row my-2">
                                    ...
                                    <small id="imgHelp" class="form-text text-muted" class="color-red">
                                        disponible sur : <a href="https://fontawesome.com/icons/" class="color-red" target="_blank">https://fontawesome.com/icons/</a>
                                    </small>
                                ...
                                <div class="form-row my-2">
                                    ...
                                    <label for="forum" class="color-red">Catégorie <span class="star-required"></span></label>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-parabellumW w-100">Créer un Forum</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addForum') and !$_SESSION['mode']) :  ?>
                ...
                <div class="collapse col-8 m-3 mx-auto" id="add_forum" aria-labelledby="add_forum" data-parent="#collapseContainer">
                    <div class="card">
                        <form action="?action=create_forum" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <label for="nomFo" class="color-red">Nom de la catégorie <span class="star-required"></span></label>
                                <input type="text" name="nom" id="nomFo" maxlength="80" class="form-control custom-text-input" required>

                            </div>

                            <div class="card-footer">
                                <button type="submit" class="btn btn-parabellumW w-100">Créer une catégorie</button>
                            </div>
