        ...
        if ((Permission::getInstance()->verifPerm("createur") or (Permission::getInstance()->verifPerm('PermsDefault', 'forum', 'perms') >= $topicd['perms'] and Permission::getInstance()->verifPerm('PermsDefault', 'forum', 'perms') >= $topicd['permsCat']) and !$_SESSION['mode']) or ($topicd['perms'] == 0 and $topicd['permsCat'] == 0)) : ?>
            ...
            <section id="pageBg">
                <div class="container-fluid col-md-9 col-lg-9 col-sm-10 mt-4">
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb" role="navigation" class="w-100">
                            <ol class="breadcrumb bg-lightest">
                                ...
                                <li class="breadcrumb-item color-red" aria-current="page">
                                    <?= $topicd['nom']; ?>
                                </li>
                        ...
                        <div class="col my-3 pr-auto">
                            <div class="card">
                                ...
                                <div class="card-header text-center bg-parabellum">
                                    ...
                                    <ul class="nav nav-pills nav-fill">
                                        <?php if (Permission::getInstance()->verifPerm("connect") && $_JoueurForum_->is_followed($id)) : ?>
                                            ...
                                            <li class="categorie-item nav-item">
                                                <a class="nav-link btn-parabellumW categorie-link" href="?&action=unfollow&id_topic=<?= $topicd['id']; ?>">
                                        ...
                                        <?php elseif (Permission::getInstance()->verifPerm("connect")) : ?>
                                            ...
                                            <li class="categorie-item nav-item">
                                                <a class="btn btn-parabellumW categorie-link" href="?&action=follow&id_topic=<?= $topicd['id']; ?>">
                                                    Ne plus suivre cette discussion
                                                </a>
                                            </li>
                                        ...
                                        <li class="categorie-item nav-item">
                                            <a class="btn btn-parabellumW categorie-link" href="?&page=forum_categorie&id=<?= $topicd['id_categorie']; ?><?= (isset($topicd['sous_forum'])) ? '&id_sous_forum=' . $topicd["sous_forum"] : ""; ?>">
                                                Revenir à l'accueil de la catégorie
                                            </a>
                                        </li>

                                        <li class="categorie-item nav-item">
                                            <a class="btn btn-parabellumW categorie-link" href="?&page=forum">
                        ...
                        <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'closeTopic') or Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'selTopic') and !$_SESSION['mode']) : ?>
                            ...
                            <div class="col-md-6 col-lg-4 col-sm-12 my-3 ml-auto">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header bg-parabellum text-center">
                                    ...
                                    <div class="card-body categories">
                                        <ul class="categorie-content nav nav-tabs">
                                            ...
                                            <li class="categorie-item nav-item w-100">
                                                <div class="dropdown">
                                                    <a class="btn btn-parabellumW btn-block dropdown-toggle" type="button" id="Actions-Modération" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                        Actions de Modération ....
                                                    </a>
                                                    <div class="dropdown-menu bg-parabellum w-100" aria-labeledby="Actions-Modérations">

                                                        <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'closeTopic')) :

                                                            if ($topicd['etat'] == 1) : ?>

                                                                <a class="dropdown-item btn-parabellumW" href="?&action=forum_moderation&id_topic=<?= $id; ?>&choix=4">
                                                                    Ouvrir la discussion
                                                                </a>

                                                            <?php else : ?>

                                                                <a class="dropdown-item btn-parabellumW" href="?&action=forum_moderation&id_topic=<?= $id; ?>&choix=1">
                                                        ...
                                                        <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'deleteTopic')) : ?>
                                                            ...
                                                            <a class="dropdown-item btn-parabellumW" href="?&action=forum_moderation&id_topic=<?= $id; ?>&choix=2">Supprimer le topic</a>

                                                        <?php endif; ?>

                                                        <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'mooveTopic')) : ?>

                                                            <a class="dropdown-item btn-parabellumW" href="?&action=forum_moderation&id_topic=<?= $id; ?>&choix=3">
                                            ...
                                            <li class="categorie-item nav-item w-100">
                                                <div class="dropdown">
                                                    <a class="btn btn-parabellumW btn-block dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        Niveau d'accès
                                                    </a>


                                                    <div class="dropdown-menu bg-parabellum w-100">
                                                        ...
                                                        <form class="px-4 py-3" action="?action=modifPermsTopics" method="POST">
                                                            ...
                                                            <button type="submit" class="btn btn-parabellumW btn-block">Modifier</button>
                    ...
                    <h3 class="text-white">Sujet : <?= $topicd['nom']; ?></h3>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col">
                                            ...
                                            <form class='form' action="?&action=unlike" method="post">
                                                <input type="hidden" name="id_answer" value="<?= $topicd['id']; ?>" />
                                                <input type="hidden" name="type" value="1" />
                                                <button type="submit" class="btn btn-parabellumW float-right" title="Ne plus aimer">
                            ...
                            if ($data['close'] == 0 or Permission::getInstance()->verifPerm('PermsForum', 'general', 'seeForumHide') and !$_SESSION['mode']) : ?>
                                ...
                                <form action="?&action=post_answer" method="post">
                                    ...
                                    <div class="form-row" style="margin-top:15px;">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-parabellumW w-100">Poster votre réponse</button>
                                        </div>
                                    </div>
