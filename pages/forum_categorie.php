    ...
    <div class="container-fluid col-md-9 col-lg-9 col-sm-10">
                                        ...
                                        <td>
                                            <div class="mx-auto d-flex align-self-center">
                                                    ...
                                                    <div class="dropdown d-inline ml-1">
                                                        ...
                                                        <div class="dropdown-menu bg-parabellum">
                                                            <form action="?action=modifPermsSousForum" method="POST">
                                                                ...
                                                                <a class="dropdown-item noHover"><input class="form-control custom-text-input" type="number" name="perms" value="<?= $sousforumd[$a]['perms']; ?>" class="form-control"></a>
                                                    ...
                                                    <div class="dropdown d-inline ml-1">
                                                        ...
                                                        <div class="dropdown-menu bg-parabellum">
                                                            <a class="btn btn-block btn-parabellumW" href="?action=ordreSousForum&ordre=<?= $sousforumd[$a]['ordre']; ?>&id=<?= $sousforumd[$a]['id']; ?>&id_cat=<?= $sousforumd[$a]['id_categorie']; ?>&modif=monter"><i class="fas fa-arrow-up"></i> Monter d'un cran</a>
                                                            <a class="btn btn-block btn-parabellumW" href="?action=ordreSousForum&ordre=<?= $sousforumd[$a]['ordre']; ?>&id=<?= $sousforumd[$a]['id']; ?>&id_cat=<?= $sousforumd[$a]['id_categorie']; ?>&modif=descendre"><i class="fas fa-arrow-down"></i> Descendre d'un cran</a>
                                                        </div>
                                                    </div>

                                                    <button type="button" onclick="openModalEditSousForum(<?= $id; ?>,<?= $sousforumd[$a]['id']; ?>, <?= $a; ?>, '<?= $sousforumd[$a]['nom']; ?>', <?php if ($sousforumd[$a]['img'] == NULL) { echo 'null';} else { echo "'".$sousforumd[$a]['img']."'"; } ?>);" class="btn btn-warning ml-1" > 
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="float-right">
                        <a class="btn btn-success px-4" role="button" data-toggle="collapse" href="#sous_cat" aria-expanded="false" aria-controls="collapseExample">
                            Créez un sous-forum
                        </a>
                    </div>
                </div>
                        ...
                        <form action="?action=create_sf" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row ">
                                    ...
                                    <label class="control-label color-red" for="nomSF">Nom</label>
                                    <input type="text" required class="form-control custom-text-input" name="nom" id="nomSF" maxlength="40" />
                                </div>

                                <div class="form-row py-2">
                                    <label class="control-label color-red" for="img">Icône</label>
                                    ...
                                    <small id="iconHelp" class="form-text text-muted">
                                        Icônes disponible : <a href="https://fontawesome.com/icons/" class="color-red" target="_blank">https://fontawesome.com/icons/</a>
                                    </small>
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-parabellumW w-100">Créer un sous-forum</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card color-red">
                                ...
                                <div class="card-body">
                                    ...
                                    if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'addPrefix')) : ?>
                                        ...
                                        <div class="row">
                                            <div class="col-12 my-2">
                                                <label for='prefix color-red'>Appliquer un préfix de discussion : </label>
                                    ...
                                    <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'epingle')) : ?>
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                    <label for='epingle' class="d-block color-red">Epingler la discussion : </label> 
                                    ...
                                    <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'closeTopic')) : ?>
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                <label for='close' class="color-red">Fermer la discussion : </label>
                                                <div class="custom-control custom-radio"> 
                                ...
                                <div class="card-footer">
                                    <button type='submit' class='btn btn-parabellumW w-100'>Valider</button>
                                </div>
        ...
        <div class="row">
                ...
                <div class="col-8 mx-auto">
					<form action="?&action=create_topic" method="post">
						<div class="card">
							...
							<div class="card-footer">
								<button type="submit" class="btn btn-parabellumW w-100">Poster</button>
							</div>
						</div>
                    </form>
                </div>
            ...
            elseif (!Permission::getInstance()->verifPerm("connect")) :
                echo '<div class="alert bg-warning text-center">Connectez-vous pour pouvoir interragir ! </div>';
            endif; ?>
        </div>
    </div>
