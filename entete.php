<header>
	<nav class="navbar navbar-toggleable-md navbar-inverse bg-parabellum navbar-dark">
                ...
                <ul class="navbar-nav ml-auto">
					...
					<div class="btn-group" role="group" aria-label="Dropdown Membres">
                        <div class="btn-group" role="group">
							<button  id="btnGroupDrop3" type="button" class="btn btn-parabellum dropdown-toggle link btn-colored" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-wow-delay="<?php echo ($i+1)/10; ?>s"><img src="https://cravatar.eu/helmavatar/<?php echo $_Joueur_['pseudo']; ?>/20" style="margin-left: -10px"> <?php echo $_Joueur_['pseudo']; ?></button>
                            <div class="dropdown-menu  dropdown-menu-right animated fadeIn" aria-labelledby="btnGroupDrop3">
								<?php 
									...
									if($_PGrades_['PermsPanel']['access'] == "on" OR $_Joueur_['rang'] == 1)
										echo '<a href="admin.php" class="dropdown-item" style="color: #d82c2e"><i class="fas fa-tachometer-alt" style="color: #d82c2e"></i> Administration</a>';
					...
					else
					{
						...
						<li class="nav-item dropdown">
						    ...
						    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						        <a class="dropdown-item hvr-forward" href="#" data-toggle="modal" data-target="#ConnectionSlide"><i class="fas fa-sign-in-alt" style="color: #000;"></i> Connexion</a>
						        <a class="dropdown-item hvr-forward" href="#" data-toggle="modal" data-target="#InscriptionSlide"><i class="fa fa-user-plus" style="color: #000;"></i> Inscription</a>
						    </div>
						</li>
						<?php 
					}
